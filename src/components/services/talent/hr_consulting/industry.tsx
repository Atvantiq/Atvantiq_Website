...
import { Code, Signal, Cloud, Shield, ShoppingBag, HeartPulse, Factory } from 'lucide-react';

const RecruitingAndHRIndustries = () => {
          ...
          <div className="w-full flex flex-wrap flex-row gap-8 justify-center">
            {industries.map((industry, index) => (
              ...
              >
                ...
                <h3
                  className={`text-lg font-semibold mb-2 transition-colors duration-300 w-[250px] ${
...
export default RecruitingAndHRIndustries;