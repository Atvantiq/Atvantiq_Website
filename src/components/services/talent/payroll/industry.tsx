...
const PayrollManagementIndustries = () => {
    ...
    <div className="bg-gradient-to-br from-gray-100 to-gray-200 py-20 px-4 relative overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col items-center">
          <div className="w-full flex felx-row flex-wrap justify-center gap-8">
            {industries.map((industry, index) => (
              ...
              >
                ...
                <h3
                  className={`text-lg font-semibold mb-2 transition-colors duration-300 w-62 ${
...
export default PayrollManagementIndustries;