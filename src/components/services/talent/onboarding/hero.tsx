...
export const SoftwareBasedOnboarding = () => (
  <ServiceSection
    title="Software-Based Onboarding & Compliance"
    subtitle="Simplifying Workforce Integration with Technology-Driven Solutions"
    description1={
      <>
       Bringing new talent into your organization should be seamless, efficient, and compliant with industry regulations. However, many businesses struggle with manual onboarding processes, inconsistent compliance checks, and delays that affect productivity.
        </>
    }
    description2={
      <>
