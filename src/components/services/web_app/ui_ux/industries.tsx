...
import { ShoppingCart, HeartPulse, DollarSign, Book, Rocket } from 'lucide-react';

const UIUXIndustries = () => {
  ...
  const industries = [
    {
      icon: ShoppingCart,
      title: "E-commerce",
      description: "Engaging shopping experiences to boost conversions."
    },
    {
      icon: HeartPulse,
      title: "Healthcare",
      description: "Easy-to-use patient portals and telemedicine apps."
    },
    {
      icon: DollarSign,
      title: "Fintech",
      description: "Secure and intuitive financial dashboards."
    },
    {
      icon: Book,
      title: "E-learning",
      description: "Interactive learning platforms for better retention."
    },
    {
      icon: Rocket,
      title: "Startups",
      description: "MVP prototyping to validate ideas quickly."
    }
  ];
