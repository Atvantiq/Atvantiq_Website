...
import { Code, ShoppingBag, HeartPulse, DollarSign, Book } from 'lucide-react';
  ...
  const industries = [
    {
      icon: Code,
      title: "Tech Startups",
      description: "SaaS, AI, and blockchain solutions."
    },
    {
      icon: ShoppingBag,
      title: "E-commerce",
      description: "Online marketplaces and niche shopping apps."
    },
    {
      icon: HeartPulse,
      title: "Healthcare",
      description: "Telemedicine, health monitoring, and patient apps."
    },
    {
      icon: DollarSign,
      title: "Fintech",
      description: "Digital wallets, payment apps, and financial dashboards."
    },
    {
      icon: Book,
      title: "E-learning",
      description: "Interactive online education platforms."
    }
  ];
    ...
    <div className="bg-gradient-to-br from-white to-gray-50 py-20 px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-slate-800 mb-16 text-center">
          Industries We Build <span className="text-[#2674D3]">MVPs For</span>
        </h2>
        <div className="relative flex flex-col items-center">
          <div className="w-full flex flex-col md:flex-col justify-center gap-12">
            {/* First row with 3 industries */}
            <div className="flex flex-col sm:flex-row sm:flex-wrap md:flex-nowrap justify-center gap-6 md:gap-12 mb-8 md:mb-0">
              {industries.slice(0, 3).map((industry, index) => (
                <div
                  key={index}
                  className="group flex flex-col items-center text-center transition-all duration-300 w-full sm:w-[80%] md:w-auto"
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap md:flex-nowrap justify-center gap-6 md:gap-12">
