...
const digitalMarketingReasons = [
  {
    ...
    description: "We run campaigns across India, USA, UAE, Canada, and Europe",
    icon: (
  ...
  },
  {
    ...
    description: "Every campaign is tracked, measured, and optimized",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Google Ads, Meta Blueprint, HubSpot certified specialists",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "We don't do templates — we build what your business needs",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "A unique balance of storytelling and smart analytics",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Monthly reports, insights, and proactive recommendations",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
