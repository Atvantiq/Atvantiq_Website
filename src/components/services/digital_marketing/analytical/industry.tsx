  ...
  const industries = [
    {
      ...
      description: "Increase conversions & average order value."
    },
    {
      icon: Briefcase,
      title: "B2B & SaaS",
      description: "Optimize lead generation and onboarding funnels."
    },
    {
      icon: HeartPulse,
      title: "Healthcare & Wellness",
      description: "Enhance patient acquisition & appointment bookings."
    },
    {
      icon: Home,
      title: "Real Estate",
      description: "Improve property inquiry and lead conversion rates."
    },
    {
      icon: BookOpen,
      title: "Education & Training",
      description: "Boost student enrollments and inquiries."
    }
  ];
    ...
    <div className="bg-gradient-to-br from-gray-100 to-gray-200 py-20 px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-slate-800 mb-16 text-center">
          Industries That Benefit from <span className="text-[#2674D3]">CRO & Analytics</span>
        </h2>
...
export default AnalyticsIndustries;