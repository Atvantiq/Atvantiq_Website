...
import { HeartPulse, Briefcase, Home, ShoppingCart, BookOpen } from 'lucide-react';
  ...
  const industries = [
    {
      icon: HeartPulse,
      title: "Healthcare",
      description: "Protect reputation with patients and clients."
    },
    {
      icon: Briefcase,
      title: "B2B & SaaS",
      description: "Build trust with potential partners and investors."
    },
    {
      icon: Home,
      title: "Real Estate",
      description: "Maintain credibility in a competitive market."
    },
    {
      icon: ShoppingCart,
      title: "E-commerce & Retail",
      description: "Improve customer trust and online reviews."
    },
    {
      icon: BookOpen,
      title: "Education & Training",
      description: "Boost enrollments with a strong reputation."
    }
  ];
    ...
    <div className="bg-gradient-to-br from-gray-100 to-gray-200 py-20 px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-slate-800 mb-16 text-center">
          Industries That Benefit from <span className="text-[#2674D3]">ORM</span>
        </h2>
