      ...
      <div className="absolute top-0 right-0 pointer-events-none z-10">
        ...
        <div className="absolute top-24 -right-60 w-120 h-120 opacity-80">
          <div className="relative w-full h-full">
            ...
            <div className="absolute top-0 left-1/2 w-5 h-5 bg-[#c5dfff] rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute -top-5 -right-60 w-120 h-120 opacity-70">
          <div className="relative w-full h-full">
            ...
            {/* Revolving dot */}
            <div className="absolute inset-0 animate-reverse-spin">
              <div className="absolute right-0 top-1/2 w-3.5 h-3.5 bg-purple-200 rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
            </div>
          </div>
        </div>
      </div>
